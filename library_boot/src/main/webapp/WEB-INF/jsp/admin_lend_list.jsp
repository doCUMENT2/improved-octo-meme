        ...
        <table class="table table-hover">
            ...
            <c:forEach items="${list}" var="alog">
                <tr>
                    ...
                    <td><fmt:formatDate value="${alog.lendDate}" pattern="yyyy-MM-dd HH:mm:dd"></fmt:formatDate></td>
                    <td><fmt:formatDate value="${alog.backDate}" pattern="yyyy-MM-dd HH:mm:dd"></fmt:formatDate></td>
                    <td>
